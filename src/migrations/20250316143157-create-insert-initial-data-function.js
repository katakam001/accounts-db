...
BEGIN
    ...
    INSERT INTO account_list (user_id, financial_year, name, credit_balance, debit_balance, "isDealer", type, "createdAt", "updatedAt")
    SELECT NEW.user_id, NEW.financial_year, name, credit_balance, debit_balance, "isDealer", type, NOW(), NOW()
    ...
    -- Insert default balance with amount set to 0
    INSERT INTO balance (user_id, financial_year, amount, "createdAt", "updatedAt")
    VALUES (NEW.user_id, NEW.financial_year, 0, NOW(), NOW());
